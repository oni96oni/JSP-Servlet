...
<body>
	<%
		if(request.getAttribute("data") != null) {
			EmpsDTO data = (EmpsDTO) request.getAttribute("data");
	%>
			<ul>
			...
			<form id="deleteForm" action="./del" method="post">
				<input type="hidden" name="empId" value="<%=data.getEmpId() %>">
			</form>
	<%
		} else {
	...
	%>
			<div>
				<button type="button" onclick="location.href='../emps';">돌아가기</button>
			</div>
	<%
		}
	%>
